...
from .views import StaffViewSet, AdminLoginView, DepartmentListView, NotificationLogListView, NotificationTemplateRetrieveUpdateView
...
urlpatterns = [
    path("api/", include([
        ...
        path('api/admin/notification-logs/<uuid:staff_id>/', NotificationLogListView.as_view(), name='notification-log-list-by-staff'),
