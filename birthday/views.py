...
from .serializers import BirthdaySerializer, StaffSerializer, UserSerializer
...
class BirthdayViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(
        operation_description="Return a list of all birthdays.",
        responses={200: BirthdaySerializer(many=True)}
    )
    def list(self, request, *args, **kwargs):
        return super().list(request, *args, **kwargs)

    @swagger_auto_schema(
        operation_description="Accept date of birth and create a new birthday.",
        request_body=StaffSerializer,
        responses={201: StaffSerializer}
    )
    def create(self, request, *args, **kwargs):
    ...
    @swagger_auto_schema(
        operation_description="Fetch a single birthday based on the id.",
        responses={200: StaffSerializer}
    )
    def retrieve(self, request, *args, **kwargs):
        return super().retrieve(request, *args, **kwargs)
    ...
    @swagger_auto_schema(
        operation_description="Update an existing birthday based on the id.",
        request_body=StaffSerializer,
        responses={200: StaffSerializer}
    )
    def update(self, request, *args, **kwargs):
    ...
    @swagger_auto_schema(
        operation_description="Removes a birthday from the database based on the id.",
        responses={204: 'No Content'}
    )
    def destroy(self, request, *args, **kwargs):
        return super().destroy(request, *args, **kwargs)
